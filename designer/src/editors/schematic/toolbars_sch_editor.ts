...
export const TOP_TOOLBAR: ToolEntry[] = [
  ...
  sep,
  { id: 'pageSettings', icon: 'page', title: 'Page Settings...', disabled: true },
  { id: 'print', icon: 'print', title: 'Print... (Ctrl+P)', disabled: true },
  { id: 'plot', icon: 'plot', title: 'Plot...', disabled: true },
  sep,
  ...
  sep,
  { id: 'navBack', icon: 'navBack', title: 'Navigate Back (Alt+Left)', disabled: true },
  { id: 'navUp', icon: 'navUp', title: 'Navigate Up (Alt+Up)', disabled: true },
  { id: 'navFwd', icon: 'navFwd', title: 'Navigate Forward (Alt+Right)', disabled: true },
  sep,
