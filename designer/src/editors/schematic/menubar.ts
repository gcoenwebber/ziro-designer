  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        stub('Zoom to Selected Objects'),
        stub('Zoom to Selection Area', 'Ctrl+F5'),
        stub('Refresh', 'Ctrl+R'),
        SEP,
        stub('Navigate Back', 'Alt+Left'),
        stub('Navigate Up', 'Alt+Up'),
        stub('Navigate Forward', 'Alt+Right'),
        stub('Previous Sheet', 'PgUp'),
        stub('Next Sheet', 'PgDn'),
        SEP,
