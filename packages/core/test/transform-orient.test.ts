...
import { readSchematic, serializeSchematic } from '../src/index.js';
...
import { transformItems } from '../src/edit/transform.js';
...
describe('transformItems command', () => {
  const fixture = readFileSync(fileURLToPath(new URL('./fixtures/nfc-antenna.kicad_sch', import.meta.url)), 'utf8');
