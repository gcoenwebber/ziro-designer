...
import { FOOTPRINT } from '../src/kicad/pcbnew/footprint.js';
import { PAD, PAD_SHAPE, PAD_ATTRIB } from '../src/kicad/pcbnew/pad.js';
import { PCB_FIELD, MANDATORY_FIELD_T } from '../src/kicad/pcbnew/pcb_field.js';
